...
infile="sand_weight.txt"  # Do not remove this file!
...
N=1  # 平均をとる行数  for sandweight-N1-rawdata.pdf
pdffile="sandweight-N1-rawdata.pdf"

# pdffile="sandweight-N24-averaged.pdf"
# N=24   # 平均をとる行数 for sandweight-N24-averaged.pdf
#        # 元のデータは NSTEP_AVERAGE_ELEMENT = 100 つまり
#        # 100^2 = 1万ステップ毎の平均値を出力している。
#        # つまり N=24とは 24万ステップ毎の平均値である。
...
######################################
### For sandweight-N24-averaged.pdf
######################################
#set yrange [0.995:1.005]

####################################
# For sandweight-N1-rawdata.pdf
####################################
set yrange [0.9:1.1]
